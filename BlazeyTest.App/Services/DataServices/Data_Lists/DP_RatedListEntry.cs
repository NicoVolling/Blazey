...
public class DP_RatedListEntry : DataPermission<User, PermissionSet, RatedListEntry>
{
    public override IQueryable<RatedListEntry> GrantedRead(User? Agent, IQueryable<RatedListEntry> Objects)
    {
